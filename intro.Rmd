...
```{r mastery-steps, fig.align='center', fig.asp=2, fig.cap="A basic model of the steps needed to become an accomplished musician.", fig.height=2, fig.width=6, out.width="100%"}
# create diagram --------------------------------------------------------------

### this has weird output in the pdf version and seems to break the latex code in the pdf version
