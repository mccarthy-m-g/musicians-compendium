...
Most sounds <!-- produced by musical instruments --> can be categorized as either noise or tone (or some blurry combination of the two). **Noise** refers to an unpitched sound, such as a clap or drum hit. **Tone** refers to a pitched sound, such as a whistle or guitar melody. Tones can be pure or complex. **Pure tones**, as their name implies, are the purest form of sound, consisting of a single sound wave. A pure tone is characterized by its amplitude, wavelength, frequency, phase, and period [@burgetal_DigitalSoundMusic_2016].
